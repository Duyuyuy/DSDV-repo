(function (d3) { 
  ...
  Promise.all([d3.json("https://raw.githubusercontent.com/holtzy/D3-graph-gallery/master/DATA/world.geojson"),
                d3.csv("https://raw.githubusercontent.com/casihoicho/DSDV-repo/Duy/data/new.csv", 
                function(d) {
                  dat.push(value(d));
            ...
            svg4.append("g")
                ...
                .on('click', function(d){
                  ...
                  d3.select(this)
                    ...
                    .append("title")
                    .text(function(d) {
                      selectedOption = d.id, total = d.total;
                  ...
                  if (total == 0) {
                    ...
                    let data2 = dat.filter(function(d) {
                      return d.code == selectedOption
                    })

                    var selected= data2.map(function(d){
                      return d.name
                    })
                    ...
                    svg2.selectAll("text")
                        ...
                        .text(function(d) {
                          return ((d.x1 - d.x0) > 40 && (d.y1 - d.y0) > 20 ) ? d.data['listed_in'] : '';
                        })
                        .attr("font-size",function(d) {
                          return ((d.x1 - d.x0) > 125 && (d.y1 - d.y0) > 50) ? '16px' : (d.x1 - d.x0) / 11 + 'px'
                        })
                        .attr("fill", "white")
